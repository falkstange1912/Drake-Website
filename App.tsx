  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-red-600 selection:text-white overflow-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-6 md:px-12 py-4">
        <div className="max-w-7xl mx-auto bg-white/70 backdrop-blur-xl border border-red-100 shadow-sm rounded-full px-6 py-4 flex justify-between items-center transition-all">
          ...
          <a href="#vision" className="bg-red-600 text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-red-700 transition-colors shadow-lg hover:shadow-red-500/25">
            Programm ansehen
          </a>
        </div>
      </header>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6 md:px-12">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
          <div className="absolute top-[-10%] right-[-5%] w-[50vw] h-[50vw] rounded-full bg-red-50 blur-3xl"></div>
          <div className="absolute bottom-[-10%] left-[-10%] w-[40vw] h-[40vw] rounded-full bg-slate-100 blur-3xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 text-red-700 text-sm font-bold tracking-widest uppercase mb-8 border border-red-100 w-fit">
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-white p-2 z-10 aspect-[4/5]">
              ...
              />
              {/* Overlay Badge */}
              <a href="#about" className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md p-4 rounded-xl shadow-lg border border-red-100 flex items-center justify-between group cursor-pointer hover:bg-white transition-colors">
                <div>
                  <p className="font-bold text-slate-900">Jens Drake</p>
                  <p className="text-sm text-slate-500">Ihr Bürgermeisterkandidat</p>
                </div>
                <div className="w-10 h-10 rounded-full bg-red-50 text-red-600 flex items-center justify-center group-hover:bg-red-600 group-hover:text-white transition-all duration-300">
                  <ArrowRight size={20} />
                </div>
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="md:col-span-2 bg-slate-50 rounded-3xl p-10 md:p-14 flex flex-col justify-center relative overflow-hidden group hover:shadow-xl transition-all duration-500">
              ...
              <div className="absolute top-0 right-0 w-64 h-64 bg-white/50 rounded-full -translate-y-1/2 translate-x-1/3 blur-2xl group-hover:bg-red-50 transition-colors duration-500"></div>
            </motion.div>

            {/* Ehrenamt Card */}
            <motion.div variants={fadeInUp} className="bg-red-600 text-white rounded-3xl p-10 flex flex-col justify-between hover:-translate-y-2 transition-transform duration-500 shadow-xl shadow-red-600/20">
              <Heart className="w-12 h-12 text-red-200 mb-8" strokeWidth={1.5} />
              <div>
                <h4 className="text-5xl font-black mb-2">41</h4>
                <p className="text-red-100 font-light text-lg">Jahre ehrenamtliches Engagement in den Vereinen unserer Region.</p>
              </div>
            </motion.div>

            {/* Beruf Card */}
            <motion.div variants={fadeInUp} className="md:col-span-3 bg-red-900 text-white rounded-3xl p-10 md:p-14 flex flex-col md:flex-row items-center gap-10 hover:shadow-2xl transition-all duration-500">
      ...
      <section id="vision" className="py-32 px-6 md:px-12 relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            {/* Goal 1 */}
            <motion.div variants={fadeInUp} className="bg-white rounded-3xl p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_40px_rgb(0,0,0,0.08)] transition-all duration-500 border border-slate-100 group hover:border-red-100">
              <div className="w-16 h-16 rounded-2xl bg-red-50 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:bg-red-600 transition-all duration-500">
